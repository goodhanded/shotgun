...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'drive_location', 'city',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'drive_location', 'city')
    ...
    models = {
        ...
        u'drive.shotgunprofile': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'shotgunprofile'", 'unique': 'True', 'to': u"orm['auth.User']"}),
