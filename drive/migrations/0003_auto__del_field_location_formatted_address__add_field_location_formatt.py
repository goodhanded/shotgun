...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'drive_location', 'formatted_address')

        # Adding field 'Location.formattedAddress'
        db.add_column(u'drive_location', 'formattedAddress',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 4, 10, 0, 0), max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Location.formatted_address'
        db.add_column(u'drive_location', 'formatted_address',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 4, 10, 0, 0), max_length=255),
                      keep_default=False)

        # Deleting field 'Location.formattedAddress'
        db.delete_column(u'drive_location', 'formattedAddress')
